      ...
      <section id="features" className="py-12 sm:py-16 md:py-24 lg:py-32">
         <div className="container px-4 sm:px-6">
                     ...
                     >
                        ...
                        >
                           <Image
                              ...
                              alt={active.heading}
                              fill
                              className="rounded-t-lg sm:rounded-tr-lg sm:rounded-tl-lg object-cover object-center"
                           />
                        </motion.div>
            ...
            <div className="z-10 mx-auto flex max-w-4xl flex-col items-center gap-8 sm:gap-10 md:gap-14 text-center">
               <div className="px-4">
                  <h1 className="mb-3 sm:mb-4 text-pretty text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-medium leading-tight bg-linear-to-br from-green-600 via-emerald-500 to-teal-600 bg-clip-text text-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6 mt-6 sm:mt-8 md:mt-12">
               <motion.div
                  ...
                  className="cursor-pointer col-span-1 md:col-span-2 lg:col-span-2 min-h-[250px] sm:min-h-[280px] lg:min-h-80"
               >
                  <WobbleCard containerClassName="h-full bg-gradient-to-br from-sky-100 to-sky-200 border border-sky-300">
                     <div className="max-w-full lg:max-w-lg p-3 sm:p-4 md:p-5 relative z-10">
                        <motion.h2
                           ...
                           className="text-left text-balance text-base sm:text-lg md:text-xl lg:text-2xl font-semibold tracking-tight text-neutral-900 bg-linear-to-r from-sky-700 via-blue-600 to-cyan-700 bg-clip-text drop-shadow-[0_2px_8px_rgba(14,165,233,0.4)]"
                        >
                           {features[0].heading}
                        </motion.h2>
                        <motion.p
                     ...
                     <motion.div
                        ...
                        className="absolute -right-2 sm:-right-4 lg:-right-[20%] -bottom-2 lg:-bottom-[10%] w-[180px] sm:w-[250px] md:w-[350px] lg:w-[500px] hidden md:block"
                     >
                        <Image
                  ...
                  <WobbleCard containerClassName="w-full h-full bg-gradient-to-br from-lime-100 to-lime-200 border border-lime-300">
                     <div className="max-w-full p-3 sm:p-4 md:p-5">
                        <motion.h2
                           ...
                           className="text-left text-balance text-base sm:text-lg md:text-xl lg:text-2xl font-semibold tracking-tight bg-linear-to-r from-lime-700 via-green-600 to-emerald-700 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(34,197,94,0.4)]"
                        >
                           {features[1].heading}
                        </motion.h2>
                        <motion.p
                  ...
                  <WobbleCard containerClassName="w-full h-full bg-gradient-to-br from-yellow-100 to-yellow-200 border border-yellow-300">
                     <div className="max-w-full p-3 sm:p-4 md:p-5">
                        <motion.h2
                           ...
                           className="text-left text-balance text-base sm:text-lg md:text-xl lg:text-2xl font-semibold tracking-tight text-neutral-900 bg-linear-to-r from-yellow-700 via-amber-600 to-orange-700 bg-clip-text drop-shadow-[0_2px_8px_rgba(245,158,11,0.4)]"
                        >
                           {features[2].heading}
                        </motion.h2>
                        <motion.p
                  ...
                  <WobbleCard containerClassName="w-full h-full bg-gradient-to-br from-red-100 to-red-200 border border-red-300">
                     <div className="max-w-full p-3 sm:p-4 md:p-5">
                        <motion.h2
                           ...
                           className="text-left text-balance text-base sm:text-lg md:text-xl lg:text-2xl font-semibold tracking-tight text-neutral-900 bg-linear-to-r from-red-700 via-rose-600 to-pink-700 bg-clip-text drop-shadow-[0_2px_8px_rgba(239,68,68,0.4)]"
                        >
                           {features[3].heading}
                        </motion.h2>
                        <motion.p
                  ...
                  <WobbleCard containerClassName="w-full h-full bg-gradient-to-br from-blue-100 to-blue-200 border border-blue-300">
                     <div className="max-w-full p-3 sm:p-4 md:p-5">
                        <motion.h2
                           ...
                           className="text-left text-balance text-base sm:text-lg md:text-xl lg:text-2xl font-semibold tracking-tight text-neutral-900 bg-linear-to-r from-blue-700 via-indigo-600 to-cyan-700 bg-clip-text drop-shadow-[0_2px_8px_rgba(59,130,246,0.4)]"
                        >
                           {features[4].heading}
                        </motion.h2>
                        <motion.p
