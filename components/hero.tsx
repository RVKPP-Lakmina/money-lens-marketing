...
const Hero = ({
  ...
  description = "Make informed decisions with confidence, stay ahead of market movements, and build a smarter financial future by joining hands with Money Lens, with tools designed for the local market and global opportunities alike.",
  image = [
    "/hero-image1.png",
    "/hero-image2.png",
    "/hero-image3.png",
  ...
  buttons = {
    primary: { text: "Get Started Free", url: "https://app.moneylens.lk/" },
